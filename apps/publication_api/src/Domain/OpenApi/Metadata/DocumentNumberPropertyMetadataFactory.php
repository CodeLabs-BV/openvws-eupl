...
final readonly class DocumentNumberPropertyMetadataFactory implements PropertyMetadataFactoryInterface
{
    ...
    public function create(string $resourceClass, string $property, array $options = []): ApiProperty
    {
        ...
        if (! $unwrapped instanceof ObjectType || $unwrapped->getClassName() !== DocumentNumber::class) {
            return $propertyMetadata;
        }
